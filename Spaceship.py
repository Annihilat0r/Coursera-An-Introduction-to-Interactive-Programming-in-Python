...
class Ship:
    ...
    def shooting(self):
        global a_missile
        a_missile = Sprite([self.pos[0] + (self.image_size[0]/2-10)*self.ang[0],
...
def rock_spawner():
    global a_rock
    a_rock = Sprite([random.randrange(0,WIDTH), random.randrange(0,HEIGHT)], [(random.random()-0.5)*difficult, (random.random()-0.5)*difficult], random.random(), random.random()*0.1, asteroid_image, asteroid_info)
...
a_rock = Sprite([random.randrange(0,WIDTH), random.randrange(0,HEIGHT)], [(random.random()-0.5)*difficult, (random.random()-0.5)*difficult], random.random(), random.random()*0.1, asteroid_image, asteroid_info)
a_missile = Sprite([random.randrange(0,WIDTH), random.randrange(0,HEIGHT)], [(random.random()-0.5)*difficult, (random.random()-0.5)*difficult], random.random(), random.random()*0.1, missile_image, missile_info, missile_sound)
